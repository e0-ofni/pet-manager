...
public class Walkpet extends AppCompatActivity implements OnMapReadyCallback, ActivityCompat.OnRequestPermissionsResultCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_walkpet);
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        ...
        mMap.setOnMapLongClickListener(new GoogleMap.OnMapLongClickListener(){
            ...
            public void onMapLongClick(final LatLng latLng) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(com.example.petmanager.Walkpet.this);
                LayoutInflater inflater = getLayoutInflater();
                View view = inflater.inflate(R.layout.activity_walkdialog, null);
                ...
                button_submit.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        ...
                        Toast.makeText(com.example.petmanager.Walkpet.this, string_placeTitle+"\n"+string_placeDesc,Toast.LENGTH_SHORT).show();
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            if (locationList.size() > 0) {
                ...
                if ( (addedMarker != null) && tracking == 1 ) {
                    double radius = 10000; // 500m distance.
                    ...
                    if ((distance < radius) && (!previousPosition.equals(currentPosition))) {
                        ...
                        Toast.makeText(com.example.petmanager.Walkpet.this, addedMarker.getTitle() + "까지 " + (int) distance + "m 남았습니다.", Toast.LENGTH_LONG).show();
                    }
                }
